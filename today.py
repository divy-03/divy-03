...
USER_NAME = os.environ['USER_NAME'] # 'AnishMane'
...
if __name__ == '__main__':
    ...
    # e.g {} and 2019-11-03T21:15:07Z for username 'AnishMane'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 12, 3))
    ...
    # if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user AnishMane
